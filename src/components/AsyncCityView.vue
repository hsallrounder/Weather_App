<template>
  <div class="flex flex-col flex-1 items-center">
    ...
    <div class="flex item-center gap-2 py-12 text-white cursor-pointer duration-150 hover:text-red-500"
      @click="removeCity">
...
const removeCity = () => {
  ...
  const updatedCitites = cities.filter((city) => city.id !== route.query.id);
  localStorage.setItem('savedCities', JSON.stringify(updatedCitites));
  router.push({
    name: "home",
  })
};
